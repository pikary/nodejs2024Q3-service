...
export class FavoritesController {
    ...
    addTrackToFavorites(
        ...
        try {
            ...
            return res.status(HttpStatus.CREATED).json({ message: 'Track added to favorites' });
        } catch (error) {
    ...
    addAlbumToFavorites(
        ...
        try {
            ...
            return res.status(HttpStatus.CREATED).json({ message: 'Album added to favorites' });
        } catch (error) {
            return res.status(error.status || HttpStatus.UNPROCESSABLE_ENTITY).json({
    ...
    addArtistToFavorites(
        ...
        try {
            ...
            return res.status(HttpStatus.CREATED).json({ message: 'Artist added to favorites' });
        } catch (error) {
            return res.status(error.status || HttpStatus.UNPROCESSABLE_ENTITY).json({
